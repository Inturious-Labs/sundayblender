...
podcast:
  ...
  shownotes: |
    ...
    In the issue of Apr 19, will sports still bring the same level of fun when robots can easily beat humans?
    
    📖 Read the full newsletter article with pictures, comments, and likes:
    https://weekly.sundayblender.com/p/robots-run-faster-than-humans-now/
...
![We Are the World](wearetheworld.jpg)
